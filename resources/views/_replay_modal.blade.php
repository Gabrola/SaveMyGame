    ...
    <ul class="collapsible" data-collapsible="accordion">
        <li>
            ...
            <div class="collapsible-body modal-collapse-body">
                ...
                @if($windowsCommandId == 'windowsCommandPartial')
                    <p><strong>This is a one-use command. Re-open this dialog to retrieve a new command.</strong></p>
                @endif
        ...
        <li>
            ...
            <div class="collapsible-body modal-collapse-body">
                ...
                @if($macCommandId == 'macCommandPartial')
                    <p><strong>This is a one-use command. Re-open this dialog to retrieve a new command.</strong></p>
                @endif
                <div style="display: flex">
